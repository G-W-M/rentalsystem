        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm rounded-lg border-0 h-100">
                    ...
                    <div class="card-body">
                        <p class="text-muted small">Every account in the system across all roles, with status and last login.
                        </p>
                        ...
                        <button class="btn btn-sm btn-outline-success me-1" onclick="downloadExport('users', 'csv')">
                            <i class="fas fa-file-csv me-1"></i> CSV
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadExport('users', 'pdf')">
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm rounded-lg border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-outline-success me-1" onclick="downloadExport('payments', 'csv')">
                            <i class="fas fa-file-csv me-1"></i> CSV
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadExport('payments', 'pdf')">
                            <i class="fas fa-file-pdf me-1"></i> PDF
                        </button>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm rounded-lg border-0 h-100">
                    ...
                    <div class="card-body">
                        <p class="text-muted small">Every maintenance request system-wide, with category, priority and
                            status.</p>
                        ...
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadExport('maintenance', 'pdf')">
                            <i class="fas fa-file-pdf me-1"></i> PDF
                        </button>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm rounded-lg border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-outline-success me-1" onclick="downloadExport('properties', 'csv')">
                            <i class="fas fa-file-csv me-1"></i> CSV
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadExport('properties', 'pdf')">
                            <i class="fas fa-file-pdf me-1"></i> PDF
                        </button>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm rounded-lg border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-outline-success me-1" onclick="downloadExport('units', 'csv')">
                            <i class="fas fa-file-csv me-1"></i> CSV
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadExport('units', 'pdf')">
                            <i class="fas fa-file-pdf me-1"></i> PDF
                        </button>
                    </div>
                </div>
